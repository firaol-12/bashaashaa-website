...
const GraduationImage= images.graduation;
  ...
  return (
    <div className="flex flex-col justify-center items-center gap-6 py-20">
      ...
      <div className="px-6 md:px-20 lg:px-100 flex justify-center items-center">
        <p className="text-lg text-white text-center  2xl:text-2xl  2xl:py-5" data-aos="zoom-in" data-aos-once="true">
